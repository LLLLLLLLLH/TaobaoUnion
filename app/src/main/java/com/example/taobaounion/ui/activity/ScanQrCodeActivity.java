...
public class ScanQrCodeActivity extends FragmentActivity {
    ...
    protected void onResume() {
        super.onResume();
        SurfaceView surfaceView = findViewById(com.tamsiree.rxfeature.R.id.capture_preview);
    ...
    private void initView() {
        mIvLight = findViewById(com.tamsiree.rxfeature.R.id.top_mask);
        mContainer = findViewById(com.tamsiree.rxfeature.R.id.capture_containter);
        mCropLayout = findViewById(com.tamsiree.rxfeature.R.id.capture_crop_layout);
        mLlScanHelp = findViewById(com.tamsiree.rxfeature.R.id.ll_scan_help);
    ...
    private void initScanerAnimation() {
        ImageView mQrLineView = findViewById(com.tamsiree.rxfeature.R.id.capture_scan_line);
    ...
    public void btn(View view) {
        ...
        if (viewId == com.tamsiree.rxfeature.R.id.top_mask) {
            light();
        } else if (viewId == com.tamsiree.rxfeature.R.id.top_back) {
            finish();
        } else if (viewId == com.tamsiree.rxfeature.R.id.top_openpicture) {
        ...
        rxDialogSure.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                if (handler != null) {
                    ...
                    handler.sendEmptyMessage(com.tamsiree.rxfeature.R.id.restart_preview);
                }
            }
        });
...
//        //处理结果
        if (result1.contains("tb.cn")){
            ...
            ToastUtils.showToast("二维码错误，无法识别");
        }
...
//        }
    ...
    final class CaptureActivityHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what == com.tamsiree.rxfeature.R.id.auto_focus) {
                if (state == State.PREVIEW) {
                    CameraManager.get().requestAutoFocus(this, com.tamsiree.rxfeature.R.id.auto_focus);
                }
            } else if (message.what == com.tamsiree.rxfeature.R.id.restart_preview) {
                restartPreviewAndDecode();
            } else if (message.what == com.tamsiree.rxfeature.R.id.decode_succeeded) {
                state = State.SUCCESS;
                handleDecode((Result) message.obj);// 解析成功，回调
            } else if (message.what == com.tamsiree.rxfeature.R.id.decode_failed) {
                state = State.PREVIEW;
                CameraManager.get().requestPreviewFrame(decodeThread.getHandler(), com.tamsiree.rxfeature.R.id.decode);
            }
        }
        ...
        public void quitSynchronously() {
            ...
            Message quit = Message.obtain(decodeThread.getHandler(), com.tamsiree.rxfeature.R.id.quit);
            quit.sendToTarget();
            try {
                decodeThread.join();
                ...
                removeMessages(com.tamsiree.rxfeature.R.id.decode_succeeded);
                removeMessages(com.tamsiree.rxfeature.R.id.decode_failed);
                removeMessages(com.tamsiree.rxfeature.R.id.decode);
                removeMessages(com.tamsiree.rxfeature.R.id.auto_focus);
            }
    ...
    final class DecodeHandler extends Handler {
        ...
        @Override
        public void handleMessage(Message message) {
            if (message.what == com.tamsiree.rxfeature.R.id.decode) {
                decode((byte[]) message.obj, message.arg1, message.arg2);
            } else if (message.what == com.tamsiree.rxfeature.R.id.quit) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(handler, com.tamsiree.rxfeature.R.id.decode_succeeded, rawResult);
            ...
            Message message = Message.obtain(handler, com.tamsiree.rxfeature.R.id.decode_failed);
            message.sendToTarget();
        }
    }
